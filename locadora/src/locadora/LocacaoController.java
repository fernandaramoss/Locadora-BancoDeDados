...
public class LocacaoController {
	...
	public void insertLocacaoValue(String cpf,double valor,int cod_locacao,int prazo,int id_locador){ 
		...
		try {
			String query= "INSERT INTO locacao(cpf_cliente,valor,id_locador,prazo,id_locador) Values ('" + cpf + "','" + valor + "','" + id_locador +",'" +prazo +",'" +id_locador + "')";
	...
	//UPDATE por prazo
	public void updateLocacaoPrazo( int prazoNovo, int prazoAntigo){
		Connection connection = null;
    	Statement statement = null;
		...
		try {
			String query= "UPDATE locacao SET prazo='" + prazoNovo + "'" + " WHERE prazo='" + prazoAntigo + "'" ;
				statement = connection.createStatement();
				statement.executeUpdate(query);
	...
	//UPDATE por valor
		public void updateLocacaoValor(double valorNovo, double valorAntigo){
			Connection connection = null;
	    	Statement statement = null;
			...
			try {
				String query= "UPDATE locacao SET valor='" + valorNovo + "'" + " WHERE valor='" + valorAntigo + "'" ;
					statement = connection.createStatement();
					statement.executeUpdate(query);
					System.out.println("atualização concluída");
