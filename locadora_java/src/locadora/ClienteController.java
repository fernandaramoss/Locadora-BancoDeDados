...
public class ClienteController {
	//INSERT
	public void insertClienteValue(String nomeCampo,String nomeCampo2,String nomeCampo3, int nomeCampo4){ 
	...
	//UPDATE nome cliente
	public void updateClienteNome( String novoNome,String cpf){
		Connection connection = null;
    	Statement statement = null;
		...
		try {
			String query= "UPDATE cliente SET nome_cliente='" + novoNome + "'" + " WHERE cpf_cliente='" + cpf + "'" ;
				statement = connection.createStatement();
				statement.executeUpdate(query);
	...
	//UPDATE endereço cliente
		public void updateClienteEnd(String endeNovo,String cpf){
			Connection connection = null;
	    	Statement statement = null;
			...
			try {
				String query= "UPDATE cliente SET end_cliente='" + endeNovo + "'" +  " WHERE cpf_cliente='" + cpf + "'" ;
					statement = connection.createStatement();
					statement.executeUpdate(query);
					System.out.println("atualização concluída");
		...
		//UPDATE telefone cliente
				public void updateClienteTel( int telNovo,String cpf){
					Connection connection = null;
			    	Statement statement = null;
					...
					try {
						String query= "UPDATE cliente SET tel_cliente='" + telNovo + "'" +  " WHERE cpf_cliente='" + cpf + "'" ;
							statement = connection.createStatement();
							statement.executeUpdate(query);
							System.out.println("atualização concluída");
